...
namespace UnifiedEducationManagementSystem.Presentation.SuperAdminForms
{
    public partial class LoginForm : Form
    {
        ...
        private readonly StudentDashboardForm studentDashboard;
        ...
        {
            {
                ...
                else
                {
                    ...
                    await activityLogsService.LogActivity(student.StudentId, "Logged In", "User logged in successfully");
                ...
                await studentDashboard.LoadActivityLogs();
                this.Hide();
